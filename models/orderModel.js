...
export default class OrderModel extends BaseModel{
    ...
    async getOrdersByEmailAndDateRange(email, startDateString, startTimeString, endDateString, endTimeString) {
        ...
        if (startDateString || startTimeString || endDateString || endTimeString) {
            ...
            if (startDateString) {
                // If startTimeString is not provided, default to "00:00:00" for the start of the day
            ...
            filteredOrders = filteredOrders.filter(order => {
                // Combine order.date and order.time from the stored order object
                // Assuming order.date is "YYYY-MM-DD" and order.time is "HH:MM:SS" or "HH:MM"
                ...
                if (isNaN(orderDateTime.getTime())) {
                    ...
                    return false; // Or true, depending on how you want to handle invalid order dates
                }
