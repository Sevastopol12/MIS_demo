document.addEventListener('DOMContentLoaded', () => {
    ...
    function fetchAndRenderOrders() {
        ...
        console.log(`Workspaceing orders from: ${apiUrl}`);
        ...
        fetch(apiUrl)
            ...
            .then(orders => {
                ...
                // --- Start Robust Date/Time Parsing ---
                // Try to parse using YYYY-MM-DDTHH:MM:SS format first (ISO 8601)
                if (o.date && typeof o.date === 'string') {
                    // Ensure time defaults to '00:00:00' if empty or null
                    const timePart = o.time && typeof o.time === 'string' && o.time.trim() !== '' ? o.time : '00:00:00';

                    // Attempt ISO format: YYYY-MM-DDTHH:MM:SS
                ...
                const displayTotal = (o.total !== undefined && o.total !== null) ? `${formatPriceVND(o.total)}` : '$0.00';
                ...
                // Attach event listeners using delegation on the table body for performance
                orderListBody.removeEventListener('click', handleOrderProductButtonClick); // Prevent multiple listeners
    ...
    // Initial load of orders when the page is fully loaded
