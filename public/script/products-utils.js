...
export function renderCard(product) {
  ...
  img.src = product.imageUrl || '/img/everon_product.png';
  ...
  clone.querySelector('.product-price').textContent = `$ ${formatPriceVND(product.price)}`;
...
export function populateProductModal(product) {
  ...
  imgEl.src           = product.imageUrl || '/img/everon_product.png';
